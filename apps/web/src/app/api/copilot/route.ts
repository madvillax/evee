...
export async function POST(request: Request) {
  ...
  const stream = await eveeAgent.stream(parsed.data.message, {
    ...
    requestContext: new RequestContext([["runtimeUserId", workspace.runtimeUser.id]]),
  });
